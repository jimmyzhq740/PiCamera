...
time.sleep(3)
picam2.start_and_capture_files("/home/jimmyzhang/Desktop/images/image_top{:d}.jpg",capture_mode=capture_config,initial_delay=3, delay=2, num_files=30)
...
for filename in os.listdir(image_import_directory):
    ...
    editted_filename=f"image_top{counter}.jpg"
    counter +=1
